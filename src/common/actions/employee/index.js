...
export const EMPLOYEE_SEARCH = awralEmployeeSearch(employeeSearchAPI)('EMPLOYEE_SEARCH')
...
export const EMPLOYEE_SAVE = awralEmployeeSave(employeeSaveAPI)('EMPLOYEE_SAVE')
...
export const EMPLOYEE_UPDATE = awralEmployeeUpdate(employeeUpdateAPI)('EMPLOYEE_UPDATE')
