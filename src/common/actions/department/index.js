...
export const DEPARTMENT_SEARCH = awralDepartmentSearch(departmentSearchAPI)('DEPARTMENT_SEARCH')
...
export const DEPARTMENT_GET = awralDepartmentGet(departmentGetAPI)('DEPARTMENT_GET')
...
export const DEPARTMENT_ADD = awralDepartmentAdd(departmentAddAPI)('DEPARTMENT_ADD')
...
export const DEPARTMENT_SAVE = awralDepartmentSave(departmentSaveAPI)('DEPARTMENT_SAVE')
...
export const DEPARTMENT_UPDATE = awralDepartmentUpdate(departmentUpdateAPI)('DEPARTMENT_UPDATE')
