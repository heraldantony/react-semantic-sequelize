...
const makeSelectJob = () => createSelector(
	selectJobDomain,
	(substate) => {
		return {
			job: substate['job'],
...
const makeSelectJobInitialValues = () => createSelector(
	selectJobDomain,
	(substate) => {
		return substate['job']
	}
...
const makeSelectSearchJob = () => createSelector(
	selectJobDomain,
	(substate) => {
		return {
			job: substate['job'],
...
const makeSelectOtherSearchJob = () => createSelector(
	selectJobDomain,
	(substate) => {
		return {
