...
export const LOCATION_SEARCH = awralLocationSearch(locationSearchAPI)('LOCATION_SEARCH')
...
export const LOCATION_SAVE = awralLocationSave(locationSaveAPI)('LOCATION_SAVE')
...
export const LOCATION_UPDATE = awralLocationUpdate(locationUpdateAPI)('LOCATION_UPDATE')
